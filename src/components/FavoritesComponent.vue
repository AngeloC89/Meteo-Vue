<template>
    <div class="container">
        ...
        <div class="d-flex align-items-center justify-content-center" v-for="(city, index) in store.data_weater" :key="index">
            <div id="favorites" class="d-flex flex-column flex-md-row h-100 p-3 gap-3 gap-md-0 my-3 my-md-1">
                ...
                <h4 id="city" class="text-center text-md-start">{{ city.name }}</h4>
                <div id="img">
                ...
                <button id="delete" class="btn btn-outline-danger rounded-circle" @click="store.methods.deleteFavorites(city)"><i
        ...
        methods: {
            ...
            async getFavorites() {
                ...
                try {
                    ...
                    this.store.data_weater = results; // Riempie data_weater con i risultati
                    console.log(this.store.data_weater);
                } catch (error) {
            ...
            sortFavorites() {
                ...
                this.store.data_weater.sort((a, b) => {
